<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="接口分组" prop="methodGroup">
        <el-input
          v-model="queryParams.methodGroup"
          placeholder="请输入接口分组"
          clearable
      ...
      <el-form-item label="实现类" prop="methodClass">
        <el-input
          v-model="queryParams.methodClass"
          placeholder="请输入实现类"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['platform:class:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['platform:class:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['platform:class:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="classList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="接口分组" align="center" prop="methodGroup" />
      <el-table-column label="接口方法" align="center" prop="method" />
      <el-table-column label="实现类" align="center" prop="methodClass" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="接口分组" prop="methodGroup">
          <el-input v-model="form.methodGroup" placeholder="请输入接口分组" />
        </el-form-item>
        <el-form-item label="接口方法" prop="method">
          <el-input v-model="form.method" placeholder="请输入接口方法" />
        </el-form-item>
        <el-form-item label="实现类" prop="methodClass">
          <el-input v-model="form.methodClass" placeholder="请输入实现类" />
        </el-form-item>
        <el-form-item label="创建人" prop="createdBy">
...
<script>
import { listClass, getClass, delClass, addClass, updateClass } from "@/api/platform/class";
