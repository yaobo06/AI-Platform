<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="应用系统账号ID" prop="appAccountId">
        <el-input
          v-model="queryParams.appAccountId"
          placeholder="请输入应用系统账号ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="接口ID" prop="methodClassId">
        <el-input
          v-model="queryParams.methodClassId"
          placeholder="请输入接口ID"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['platform:method:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['platform:method:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['platform:method:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['platform:method:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="methodList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="应用系统账号ID" align="center" prop="appAccountId" />
      <el-table-column label="接口ID" align="center" prop="methodClassId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="应用系统账号ID" prop="appAccountId">
          <el-input v-model="form.appAccountId" placeholder="请输入应用系统账号ID" />
        </el-form-item>
        <el-form-item label="接口ID" prop="methodClassId">
          <el-input v-model="form.methodClassId" placeholder="请输入接口ID" />
        </el-form-item>
        <el-form-item label="创建人" prop="createdBy">
...
<script>
import { listMethod, getMethod, delMethod, addMethod, updateMethod } from "@/api/platform/method";
