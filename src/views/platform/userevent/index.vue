  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="是否需要发送钉钉消息" prop="ifSendTalkMsg">
        <el-input
          v-model="queryParams.ifSendTalkMsg"
          placeholder="请输入是否需要发送钉钉消息：1-是，0-否"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="是否需要发送工作通知" prop="ifSendWorkNotice">
        <el-input
          v-model="queryParams.ifSendWorkNotice"
          placeholder="请输入是否需要发送工作通知：1-是，0-否"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
...
<!--      <el-form-item label="创建人" prop="createdBy">
      ...
      <el-form-item label="逻辑删除标记" prop="deleteFlag">
        <el-input
          v-model="queryParams.deleteFlag"
          placeholder="请输入逻辑删除标记：1-已删除，0-未删除"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>-->
    ...
    <el-table v-loading="loading" :data="eventList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="钉钉工号" align="center" prop="employId" />
      <el-table-column label="用户id" align="center" prop="userId" />
      <el-table-column label="是否需要发送钉钉消息" align="center" prop="ifSendTalkMsg" />
      <el-table-column label="是否需要发送工作通知" align="center" prop="ifSendWorkNotice" />
      <el-table-column label="关联的事件表id" align="center" prop="eventType" />
      ...
      <el-table-column label="逻辑删除标记" align="center" prop="deleteFlag" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="逻辑删除标记" prop="deleteFlag">
          <el-input v-model="form.deleteFlag" placeholder="请输入逻辑删除标记：1-已删除，0-未删除" />
        </el-form-item>
      </el-form>
