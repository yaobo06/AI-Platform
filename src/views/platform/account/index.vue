<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="应用系统密码" prop="appCode">
        <el-input
          v-model="queryParams.appCode"
          placeholder="请输入应用系统密码"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['platform:account:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['platform:account:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['platform:account:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['platform:account:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="accountList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主键，供其他表做外键" align="center" prop="id" />
      <el-table-column label="应用系统名称" align="center" prop="appName" />
      <el-table-column label="应用系统账号" align="center" prop="appKey" />
      <el-table-column label="应用系统密码" align="center" prop="appCode" />
      <el-table-column label="开始时间" align="center" prop="startData" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.startData, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="结束时间" align="center" prop="endData" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.endData, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="应用系统名称" prop="appName">
          <el-input v-model="form.appName" placeholder="请输入应用系统名称" />
        </el-form-item>
        <el-form-item label="应用系统账号" prop="appKey">
          <el-input v-model="form.appKey" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="应用系统密码" prop="appCode">
          <el-input v-model="form.appCode" placeholder="请输入应用系统密码" />
        </el-form-item>
        <el-form-item label="开始时间" prop="startData">
          <el-date-picker clearable
...
<script>
import { listAccount, getAccount, delAccount, addAccount, updateAccount } from "@/api/platform/account";
