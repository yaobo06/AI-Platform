<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="参数组" prop="paramGroup">
        <el-input
          v-model="queryParams.paramGroup"
          placeholder="请输入参数组"
          clearable
      ...
      <el-form-item label="说明" prop="paramRemark">
        <el-input
          v-model="queryParams.paramRemark"
          placeholder="请输入说明"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['platform:paramconfig:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['platform:paramconfig:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="说明" align="center" prop="paramRemark" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="参数组" prop="paramGroup">
          <el-input v-model="form.paramGroup" placeholder="请输入参数组" />
        </el-form-item>
        <el-form-item label="参数键" prop="paramKey">
        ...
        <el-form-item label="说明" prop="paramRemark">
          <el-input v-model="form.paramRemark" placeholder="请输入说明" />
        </el-form-item>
        <el-form-item label="创建人" prop="createdBy">
...
<script>
import { listConfig, getConfig, delConfig, addConfig, updateConfig } from "@/api/platform/paramconfig";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/paramconfig/export', {
        ...this.queryParams
