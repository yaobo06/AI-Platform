<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="状态码" prop="statusCode">
        <el-input
          ...
          placeholder="请输入状态码：1热门 2新品 3推荐"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="modelsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="模型图片URL" width="400" align="center" prop="imageUrl" />
      <el-table-column label="分类类型" align="center" prop="categoryType" />
      <el-table-column label="状态码" align="center" prop="statusCode" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="模型图片URL" prop="imageUrl">
          <ImageUpload v-model="form.imageUrl" limit="1" />
        </el-form-item>
        <el-form-item label="状态码：1热门 2新品 3推荐" prop="statusCode">
          <el-input v-model="form.statusCode" placeholder="请输入状态码：1热门 2新品 3推荐" />
        </el-form-item>
        ...
        <el-form-item label="体验链接" prop="experienceUrl">
          <el-input v-model="form.experienceUrl" type="textarea" placeholder="请输入内容" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除AI模型编号为"' + ids + '"的数据项？').then(function() {
