  ...
  <div class="cm-image-container">
    ...
    <div class="main">
      ...
      <el-table v-loading="loading" :data="modelList" @selection-change="handleSelectionChange" border>
        ...
        <el-table-column label="Deployment Name" align="center" prop="azureDeploymentName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="Api Key" prop="apiKey" required :rules="[{required: true, message: '请输入apiKey', trigger: 'blur'}]">
          <el-input v-model="form.apiKey" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="Endpoint" prop="endpoint">
          <el-input v-model="form.endpoint" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="Base Url" prop="baseUrl">
          <el-input v-model="form.baseUrl" placeholder="请输入" />
        </el-form-item>
        <el-form-item v-if="!!activeNavItem.useImage" label="图片大小" prop="imageSize">
          <el-select v-model="form.imageSize" filterable placeholder="请选择" style="width: 100%;">
            <el-option
        ...
        <el-form-item v-if="!!activeNavItem.useImage" label="图片质量" prop="imageQuality">
          <el-select v-model="form.imageQuality" filterable placeholder="请选择" style="width: 100%;">
            <el-option
              v-for="item in imageQualityList"
              :key="item.value"
              :label="item.label"
              :value="item.value">
            </el-option>
        ...
        <el-form-item v-if="!!activeNavItem.useImage" label="图片风格" prop="imageStyle">
          <el-select v-model="form.imageStyle" filterable placeholder="请选择" style="width: 100%;">
            <el-option
